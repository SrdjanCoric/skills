...
The first four work as a pipeline: talk through an idea, turn the decisions into a PRD, break the PRD into a phased plan, then implement it one feature at a time. Each also works on its own.
